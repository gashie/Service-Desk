...
exports.protect = asynHandler(async (req, res, next) => {
  ...
  try {
    ...
    if (checkIp === userIp) {
      ...
      CatchHistory(
        {
          api_response: `Channel login failed: device or ip mismatch`,
          function_name: "protect-middleware",
          date_started: systemDate,
          sql_action: "",
          event: "Middleware to protect routes",
          actor: "",
        },
        req
      );
    ...
    CatchHistory(
      {
        api_response: `Channel login failed: invalid token or token has expired`,
        function_name: "protect-middleware",
        date_started: systemDate,
        sql_action: "",
        event: "Middleware to protect routes",
